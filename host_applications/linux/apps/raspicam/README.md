...
There are three applications provided, **raspistill**, **raspivid**, **raspiyuv** and **raspividyuv**. raspistill and raspistillyuv are very similar and are intended for capturing images, raspivid is for capturing video.
